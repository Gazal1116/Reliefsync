...
import { CalendarDays, CircleUserRound, LogOut, Mail, PencilLine, ShieldCheck, Sparkles, User } from "lucide-react";
        ...
        {loading ? (
          ...
          <div style={{ display: "grid", gap: "20px" }}>
            <div style={{ display: "grid", gap: "16px", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))" }}>
              ...
              <ProfileCard icon={User} label="Mobile Number" value={profile?.phone || "Not available"} accent="#f9a8d4" />
