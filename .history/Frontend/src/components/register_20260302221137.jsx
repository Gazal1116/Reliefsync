...
export default function Register() {
	...
	return (
		<main className="min-h-screen flex items-center justify-center px-4 py-12">
			<section className="w-full max-w-lg card-surface rounded-xl p-8 shadow-2xl">
				{/* header with logo */}
					...
					<div className="grid gap-4">
						<label className="block">
							...
							<input
								...
								className="mt-1 w-full rounded-md focus:outline-none transition-shadow"
								style={{ backgroundColor: 'transparent', borderBottom: '1px solid rgba(255,255,255,0.06)', color: 'var(--text-high)' }}
								required
							/>
						</label>
