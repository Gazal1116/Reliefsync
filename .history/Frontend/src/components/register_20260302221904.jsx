			...
			<section className="w-full max-w-lg bg-surface border border-border rounded-xl p-8 shadow-soft-dark">
				...
				<form className="mt-6" onSubmit={handleSubmit} noValidate>
					<div className="grid gap-4">
						...
						<button
							type="submit"
							className="w-full py-3 rounded-md mt-1 flex items-center justify-center gap-2 bg-gradient-to-r from-primary to-accent text-white shadow-lg transform transition-transform hover:-translate-y-0.5 disabled:opacity-70"
							disabled={loading}
							aria-busy={loading}
						>
						...
						<div className="text-center text-sm mt-3 text-text-mid">
							Already have an account? <a href="/login" className="font-medium text-accent">Log in</a>
						</div>

						<p className="text-xs text-center mt-4 text-text-low">
							By creating an account you agree to our <a href="#" className="text-accent">Terms</a> and <a href="#" className="text-accent">Privacy Policy</a>.
						</p>
					</div>
				</form>
			</section>
